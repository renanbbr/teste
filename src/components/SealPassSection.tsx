...
const allLogos = [{
  ...
  src: "/partner-logos/nina-doces.png",
  alt: "Nina Doces de Pelotas"
}, {
  src: "/partner-logos/nina-fit.png",
  alt: "Nina Fit Doces Proteicos"
}, {
...
export const SealPassSection = ({
  ...
  return <section className="relative bg-black pt-20 pb-8 overflow-hidden my-0 py-[8px]">
      
      {/* Background Video - Condicional */}
      {videoSrc && <div className="absolute inset-0">
